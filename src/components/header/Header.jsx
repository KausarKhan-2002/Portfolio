    ...
    >
      ...
      >
        ...
        <h2 className="sm:border-r-2 sm:border-slate-500 sm:pr-5">
          Call me: <button onClick={handleCall} className="text-blue-500 hover:text-blue-400">+919260952373</button>
        </h2>
      ...
      <div className="relative flex justify-between px-10 md:px-20">
        ...
        <div id="logo" className="py-3">
          <h2 className="text-lg lg:text-2xl font-bold lg:fixed bg-white lg:top-0 lg:w-[200px] lg:h-[114px] lg:shadow-md flex justify-center items-center">
            <span className="text-blue-500">Kausar</span>.<span className="title">Khan</span>
          </h2>
        </div>
